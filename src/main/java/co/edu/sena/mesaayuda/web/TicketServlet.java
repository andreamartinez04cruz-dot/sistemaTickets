...
public class TicketServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("historial".equalsIgnoreCase(action)) {
            List<HistorialFuncionarioDTO> tickets = ticketService.listarTicketsPorSolicitante(solicitante.getId());
    ...
    protected void doPost(
        ...
        if ((rolUsuarioPost == null || rolUsuarioPost.isEmpty()) && solicitante != null) {
            List<co.edu.sena.mesaayuda.modelo.Rol> roles = solicitante.getRoles();
            if (roles != null) {
                for (co.edu.sena.mesaayuda.modelo.Rol rol : roles) {
