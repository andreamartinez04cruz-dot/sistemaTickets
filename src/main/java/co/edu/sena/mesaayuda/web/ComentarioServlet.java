...
public class ComentarioServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idTicketStr != null && texto != null && !texto.trim().isEmpty()) {
            ...
            if (ticket != null && ticket.getIdSolicitante() != usuario.getId()) {
...
// 6. Redireccionar al detalle del ticket
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ticket.getIdSolicitante() != usuario.getId()) {
            response.sendRedirect(request.getContextPath() + "/tickets/registrar?action=historial");
            return;
        }
        ...
        if ("AGENTE".equalsIgnoreCase(rolUsuario) || "FUNCIONARIO".equalsIgnoreCase(rolUsuario) || "ADMIN".equalsIgnoreCase(rolUsuario)) {
