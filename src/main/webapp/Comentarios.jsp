...
<html class="light" lang="es">
    ...
    <head>
        ...
        <%-- Si usas scriptlets de Java puro en tu JSP --%>
        <%
            String mensajeExito = (String) session.getAttribute("mensajeExito");
            if (mensajeExito != null) {
                // Limpiamos el atributo para que la alerta no se repita al recargar
    ...
    <body class="bg-background text-on-surface min-h-screen flex flex-col">
                                        ...
                                        <div class="flex gap-4">
                                            ...
                                            <div class="flex-shrink-0">
                                                ...
                                                <div class="w-10 h-10 rounded-full
                                                    ...
                                                    ${not empty comentario.nombreUsuario
                                                      ? comentario.nombreUsuario.substring(0,1)
                                                      : 'U'}
        ...
        <div class="md:hidden fixed bottom-0 left-0
             w-full bg-white
