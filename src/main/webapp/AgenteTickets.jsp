...
<html lang="es"><head>
    ...
    <body class="bg-background text-on-background min-h-screen flex flex-col pt-16">
        ...
        <header class="bg-surface dark:bg-surface-dim shadow-sm fixed top-0 w-full z-50 flex justify-between items-center px-margin-mobile md:px-margin-desktop h-16">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="w-8 h-8 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center font-bold font-label-md text-label-md overflow-hidden">
                    <img class="w-full h-full object-cover" data-alt="A professional headshot of a technical support agent, wearing a headset, smiling slightly, set against a clean, light mode office background with soft lighting, reflecting a modern corporate environment." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDVcgvaeTOM--M2WmIIMQ23lpVNw1zjeoGbv5KJB02RR1MQbF0lbgMnCn9QHx-6C0i-odfMGQOuaOhjnFrH-BVOGTPZRYakdMSb9KNcpEDZ9DLGXHaUcBelexJNOHN3RMMHt6Clag4oycj1bCZl2vnNDRF6Nm6WKXFTbmu6dbn1LTAyj-3XKiE3FN0GpGLMq8d1o4exs3oYrdnlX3usm2w0pdQ8n_J4hbQt9CTZhrMqrBmzKwgIaAJp"/>
                </div>
            </div>
        </header>
        <!-- Main Content -->
        ...
        <!-- Footer from JSON -->
        <footer class="bg-surface-container-lowest dark:bg-inverse-surface border-t border-outline-variant w-full py-stack-md px-margin-mobile flex flex-col md:flex-row justify-between items-center gap-stack-sm mt-auto">
